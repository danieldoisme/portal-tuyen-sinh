...
const AnnouncementsUniversityPage = () => {
  const [currentPage, setCurrentPage] = useState(1);
  const itemsPerPage = 12;

  const totalPages = Math.ceil(universityAdmissionsData.length / itemsPerPage);
  ...
  const selectedData = universityAdmissionsData.slice(
    startIndex,
...
export default AnnouncementsUniversityPage;
