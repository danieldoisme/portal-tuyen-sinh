...
const AnnouncementsOtherPage = () => {
  const [currentPage, setCurrentPage] = useState(1);
  const itemsPerPage = 12;

  const totalPages = Math.ceil(otherAdmissionsData.length / itemsPerPage);
  ...
  const selectedData = otherAdmissionsData.slice(
    startIndex,
...
export default AnnouncementsOtherPage;
