    ...
    return (
      <div className="min-h-screen flex items-center justify-center text-center">
        <div>
          ...
          <p className="text-gray-600">Không tìm thấy dữ liệu điểm trúng tuyển cho năm {year}</p>
        </div>
      </div>
    );
  }
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <div className="flex items-center justify-center gap-2 text-sm mb-2 text-white">
            ...
            <span className="text-white">Xem điểm các năm trước</span>
             <ChevronRight size={12} className="inline-block" />
            <span className="text-white font-medium">Điểm trúng tuyển {year}</span>
          </div>
          {/* Title */}
          <h1 className="text-3xl md:text-4xl font-bold">Điểm trúng tuyển {year}</h1>
        </div>
      </div>
