    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mb-2">Bạn đang tham gia hệ thống xét tuyển trực tuyến của PTIT</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12 max-w-6xl mx-auto">
          ...
          >
            <div className="flex items-center mb-6">
              ...
              <h3 className="text-xl font-bold text-gray-800">Nộp hồ sơ trực tuyến</h3>
            </div>
            
            <p className="text-gray-600 mb-6">
              Bạn đang tham gia hệ thống xét tuyển trực tuyển đại học của PTIT
            </p>
          ...
          >
            <div className="flex items-center mb-6">
              ...
              <h3 className="text-xl font-bold text-gray-800">Nhập học trực tuyến</h3>
            </div>
            
            <p className="text-gray-600 mb-6">
              Bạn đang tham gia hệ thống nhập học trực tuyển đại học của PTIT
            </p>
          ...
          <div className="bg-white rounded-lg shadow-lg p-6">
            <div className="flex items-center mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Tổng hợp một số ngành được yêu thích nhất qua các năm tuyển sinh</p>
              </div>
            </div>
              ...
              {hotMajors.map((major, index) => (
                <div key={index} className="flex items-center justify-between p-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                  <div className="flex items-center">
                    <span className={`inline-block px-2 py-1 text-xs font-bold text-white rounded mr-3 ${major.color === 'red' ? 'bg-red-500' : 'bg-green-500'}`}>
                      {major.tag}
                    </span>
          ...
          <div className="bg-white rounded-lg shadow-lg p-6">
            <div className="flex items-center mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Tổng hợp một số ngành mới nhất hiện nay</p>
              </div>
            </div>
            ...
            <div className="space-y-3">
              {newMajors.map((major, index) => (
                <div key={index} className="flex items-center justify-between p-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                  <div className="flex items-center">
                    <span className={`inline-block px-2 py-1 text-xs font-bold text-white rounded mr-3 ${major.color === 'green' ? 'bg-green-500' : 'bg-red-500'}`}>
                      {major.tag}
                    </span>
                    <span className="text-sm text-gray-800">{major.name}</span>
                  </div>
